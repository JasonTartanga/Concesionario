...
public class MenuVehiculos extends JDialog implements ActionListener {
	...
	public MenuVehiculos(Menu menu, boolean b, DAO dao) {
		super(menu);
		this.setModal(b);
	...
	private void modificar() {
		VehiculoAUsuario vau = new VehiculoAUsuario(this, true, dao);
	...
	private void introducir() {
		IntroducirCoche intro = new IntroducirCoche(this, true, dao);
		this.setVisible(false);
